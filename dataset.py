...
def get_dataset(args, split, sparse=True, **kwargs):
    ...
    if args.dataset == "Cora" or args.dataset == "CiteSeer" or args.dataset == "PubMed":
        ...
        original_dataset = get_planetoid_dataset(args.dataset, args.normalize_features)
        data = dataset[0]
        ...
        original_dataset = get_coauthor_dataset(args.dataset, args.normalize_features)
        data = dataset[0]
        if args.random_splits > 0:
    ...
    return original_dataset, dataset, data, split_idx
